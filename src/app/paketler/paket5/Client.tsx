...
export default function Paket5RestaurantColorfulClient() {
          ...
          <div className="md:col-span-7">
            ...
            <div className="mt-6 flex flex-wrap gap-2 text-sm">
              {['Vejetaryen Seçenek', 'Glütensiz Makarna', 'Sommelier Eşleşmesi'].map((t) => (
                <span key={t} className="px-2 py-1 rounded-full border bg-emerald-50 border-emerald-200 text-emerald-800">
                  {t}
                </span>
              ))}
            </div>
      ...
      <section id="seckiler" className="border-t">
        <div className="mx-auto max-w-7xl px-4 py-16 md:py-24">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            {[
              { name: 'Burrata Caprese', desc: 'Renkli domatesler, burrata, fesleğen yağı', img: pick(1) },
              { name: 'Spaghetti Carbonara', desc: 'Pecorino, yumurta, guanciale', img: pick(2) },
              { name: 'Panna Cotta & Çilek', desc: 'Vanilya notaları, çilek sos', img: pick(3) },
            ].map((item) => (
            ...
            <div className="rounded-2xl border bg-white p-6">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                {['18:00', '18:30', '19:00', '19:30', '20:00', '21:00'].map((t) => (
                  <span key={t} className="px-3 py-1.5 rounded-full border bg-emerald-50 text-emerald-800 border-emerald-200">
                    {t}
                  </span>
                ))}
              </div>
