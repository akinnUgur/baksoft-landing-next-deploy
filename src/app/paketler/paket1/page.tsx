...
/**
 * Paket16 · Interior Architecture — Full
 * - Dergi kapak hero + Style Explorer (Scandi / Industrial / Contemporary)
 * - Asimetrik Proje Mozaiği + Inline Case Reader
 * - Malzeme Kütüphanesi + Kombin Önerici (Base/Accent/Metal)
 * - Before/After Slider (inline)
 * - Süreç Timeline
 * - Space Budget Mini Hesaplayıcı (m², program, kalite) — tamamen UI
 */
...
type StylePreset = {
  key: StyleKey;
  name: string;
  palette: { bg: string; ink: string; accent: string; soft: string }; // ink tutuluyor ama kullanılmıyor
  collage: string[];
  textureClass: string;
};
...
type Project = {
  ...
  materials: string[]; // names from MATERIALS list
};
...
const PRESETS: StylePreset[] = [
  {
    ...
    collage: [
      'https://images.pexels.com/photos/6585753/pexels-photo-6585753.jpeg?auto=compress&cs=tinysrgb&w=1600',
      'https://images.pexels.com/photos/6588853/pexels-photo-6588853.jpeg?auto=compress&cs=tinysrgb&w=1600',
      'https://images.pexels.com/photos/6588851/pexels-photo-6588851.jpeg?auto=compress&cs=tinysrgb&w=1600',
    ],
    textureClass:
  ...
  },
  {
    ...
    collage: [
      'https://images.pexels.com/photos/373548/pexels-photo-373548.jpeg?auto=compress&cs=tinysrgb&w=1600',
      'https://images.pexels.com/photos/279719/pexels-photo-279719.jpeg?auto=compress&cs=tinysrgb&w=1600',
      'https://images.pexels.com/photos/5843996/pexels-photo-5843996.jpeg?auto=compress&cs=tinysrgb&w=1600',
    ],
    textureClass:
  ...
  },
  {
    ...
    collage: [
      'https://images.pexels.com/photos/6588855/pexels-photo-6588855.jpeg?auto=compress&cs=tinysrgb&w=1600',
      'https://images.pexels.com/photos/6588854/pexels-photo-6588854.jpeg?auto=compress&cs=tinysrgb&w=1600',
      'https://images.pexels.com/photos/6588860/pexels-photo-6588860.jpeg?auto=compress&cs=tinysrgb&w=1600',
    ],
    textureClass:
...
const PROJECTS: Project[] = [
  {
    ...
    location: 'İstanbul',
    cover:
      'https://images.pexels.com/photos/7031417/pexels-photo-7031417.jpeg?auto=compress&cs=tinysrgb&w=1600',
    photos: [
      'https://images.pexels.com/photos/6588855/pexels-photo-6588855.jpeg?auto=compress&cs=tinysrgb&w=1600',
      'https://images.pexels.com/photos/6588851/pexels-photo-6588851.jpeg?auto=compress&cs=tinysrgb&w=1600',
      'https://images.pexels.com/photos/6588854/pexels-photo-6588854.jpeg?auto=compress&cs=tinysrgb&w=1600',
  ...
  },
  {
    ...
    photos: [
      ...
      'https://images.pexels.com/photos/3182796/pexels-photo-3182796.jpeg?auto=compress&cs=tinysrgb&w=1600',
      'https://images.pexels.com/photos/3747135/pexels-photo-3747135.jpeg?auto=compress&cs=tinysrgb&w=1600',
    ],
    blurb:
  ...
  },
  {
    ...
    location: 'İzmir',
    cover:
      'https://images.pexels.com/photos/247929/pexels-photo-247929.jpeg?auto=compress&cs=tinysrgb&w=1600',
    photos: [
  ...
  },
  {
    ...
    location: 'İstanbul',
    cover:
      'https://images.pexels.com/photos/6634756/pexels-photo-6634756.jpeg?auto=compress&cs=tinysrgb&w=1600',
    photos: [
      'https://images.pexels.com/photos/7176307/pexels-photo-7176307.jpeg?auto=compress&cs=tinysrgb&w=1600',
      'https://images.pexels.com/photos/6812525/pexels-photo-6812525.jpeg?auto=compress&cs=tinysrgb&w=1600',
      'https://images.pexels.com/photos/7580258/pexels-photo-7580258.jpeg?auto=compress&cs=tinysrgb&w=1600',
    ],
    blurb:
...
/* ============================ Page ============================ */
export default function Paket16Interior() {
  // Style
  ...
  const cssVars: React.CSSProperties = {
    ...
    // ['--ink' as any]: active.palette.ink, // kaldırıldı
  ...
  // Materials
  const [picked, setPicked] = useState<string[]>([]); // material names
...
>
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 md:py-24 grid md:grid-cols-12 gap-10 items-start">
          <div className="md:col-span-6">
            ...
            <h1 className="mt-5 text-4xl md:text-6xl font-serif leading-[1.05]">
              Mekânı <em className="not-italic" style={{ color: 'var(--accent)' }}>hikâyeye</em> çeviriyoruz.
            </h1>
            <p className="mt-4 text-lg opacity-80 max-w-2xl">
              Işık, oran, doku ve akış. Konutu, ofisi ve sosyal alanları markanın diliyle birleştiren <strong>Atelier Aure</strong> yaklaşımı.
            </p>
            {/* Principles */}
      ...
      <section id="mosaic" className="mx-auto max-w-7xl px-4 py-14" style={paletteBg}>
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <p className="opacity-80 mt-1">Asimetrik grid; hover’da çizim/spec, tıklayınca inline okuma.</p>
          </div>
          <div className="shrink-0">
            ...
            >
              {(['All', 'Residential', 'Office', 'Retail', 'Hospitality', 'Healthcare'] as const).map((p) => (
        ...
        <div className="mt-6 grid grid-cols-12 gap-4">
          {PROJECTS.filter((pr) => (filter === 'All' ? true : pr.type === filter)).map((pr, idx) => (
            <article
              key={pr.id}
            ...
            >
              <div
                className={`${
                  idx % 5 === 0 ? 'col-span-12 md:col-span-8 row-span-2' : idx % 3 === 0 ? 'col-span-12 md:col-span-4' : 'col-span-12 md:col-span-6'
                } col-span-12`}
              >
                <ImgSafe
                  src={pr.cover}
              ...
              <button onClick={() => setActiveCase(pr)} className="absolute inset-0" aria-label={`Aç: ${pr.title}`} />
            </article>
          ))}
        </div>
        ...
        {activeCase && (
          <div
            ...
            style={{ borderColor: 'rgb(0 0 0 / 0.12)', background: 'color-mix(in oklab, var(--soft) 35%, transparent)' }}
          >
            <div className="flex items-center justify-between px-4 h-12 border-b" style={{ borderColor: 'rgb(0 0 0 / 0.12)' }}>
            ...
            <div className="p-5 grid lg:grid-cols-12 gap-6">
              <div className="lg:col-span-7">
                <ImgSafe src={activeCase.photos[0]} alt={activeCase.title} className="w-full aspect-[16/9] object-cover rounded-xl" />
                <p className="mt-4 text-lg opacity-90">{activeCase.blurb}</p>
                <div className="mt-4 grid grid-cols-3 gap-3">
                  {activeCase.photos.slice(1).map((ph, i) => (
                    <ImgSafe key={i} src={ph} alt={`${activeCase.title} ${i}`} className="w-full aspect-[4/3] object-cover rounded-xl" />
                  ))}
                </div>
              </div>
                      ...
                      return (
                        <div key={m} className="text-center">
                          <div
                            ...
                            style={{ background: sw.c, borderColor: 'rgb(0 0 0 / 0.10)' }}
                          />
      ...
      <section id="materials" className="mx-auto max-w-7xl px-4 py-14" style={paletteBg}>
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <p className="opacity-80 mt-1">En fazla 3 swatch seç; algoritma Base/Accent/Metal rol önerisi yapsın.</p>
          </div>
          <button
            onClick={() => setPicked([])}
            className="h-10 px-3 rounded-xl border text-sm hover:opacity-100"
            style={{ borderColor: 'rgb(0 0 0 / 0.15)', background: 'color-mix(in oklab, var(--soft) 50%, transparent)' }}
          >
            Sıfırla
          </button>
        </div>
          ...
          {MATERIALS.map((m) => {
            ...
            return (
              <button
                key={m.n}
                onClick={() => {
                  setPicked((prev) => (active ? prev.filter((x) => x !== m.n) : prev.length >= 3 ? prev : [...prev, m.n]));
                }}
      ...
      <section id="beforeafter" className="mx-auto max-w-7xl px-4 py-14" style={paletteBg}>
        ...
        <div className="mt-5 grid md:grid-cols-2 gap-6">
          <BeforeAfter
            before="https://images.pexels.com/photos/3965545/pexels-photo-3965545.jpeg?auto=compress&cs=tinysrgb&w=1600"
            after="https://images.pexels.com/photos/6588855/pexels-photo-6588855.jpeg?auto=compress&cs=tinysrgb&w=1600"
          />
          <BeforeAfter
            before="https://images.pexels.com/photos/279719/pexels-photo-279719.jpeg?auto=compress&cs=tinysrgb&w=1600"
            after="https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&cs=tinysrgb&w=1600"
          />
        </div>
      </section>
      ...
      <section id="process" className="mx-auto max-w-7xl px-4 py-14" style={paletteBg}>
        ...
        <div className="mt-6 grid md:grid-cols-3 gap-5">
          {[
            ...
            >
              <span className="absolute -top-3 left-4 h-6 w-6 rounded-full grid place-items-center text-sm" style={{ background: 'var(--accent)', color: 'var(--bg)' }}>
                {i + 1}
              </span>
      ...
      <section id="budget" className="mx-auto max-w-7xl px-4 py-14" style={paletteBg}>
        ...
        <p className="opacity-80 mt-1">Hızlı tahmin: m² × program × kalite. Tamamen demonstratif.</p>

        <div className="mt-5 grid lg:grid-cols-12 gap-6">
          <div
            className="lg:col-span-5 rounded-2xl p-5 border"
            style={{ borderColor: 'rgb(0 0 0 / 0.12)', background: 'color-mix(in oklab, var(--soft) 40%, transparent)' }}
          >
            <div className="grid grid-cols-2 gap-3 text-sm">
              <div>
                ...
                <input
                  ...
                  style={{ borderColor: 'rgb(0 0 0 / 0.15)', background: 'var(--bg)' }}
                />
              </div>
              <div>
                ...
                <select
                  ...
                  style={{ borderColor: 'rgb(0 0 0 / 0.15)', background: 'var(--bg)' }}
                >
                  {(['Residential', 'Office', 'Retail', 'Hospitality', 'Healthcare'] as const).map((p) => (
                ...
                <div className="mt-1 flex gap-2">
                  {(['Standard', 'Premium', 'Luxury'] as const).map((q) => (
                    <button
                      ...
                      style={{
                        borderColor: quality === q ? 'var(--accent)' : 'rgb(0 0 0 / 0.15)',
                        background: quality === q ? 'color-mix(in oklab, var(--soft) 55%, transparent)' : 'var(--bg)',
                      }}
                    >
                      {q}
                    </button>
      ...
      <footer className="border-t" style={{ borderColor: 'rgb(0 0 0 / 0.12)', background: 'color-mix(in oklab, var(--soft) 55%, var(--bg))' }}>
...
/* --- Combo Suggestion --- */
function ComboSuggestion({ picks }: { picks: { n: string; c: string; cat: string }[] }) {
  if (!picks.length) {
    return (
      <div
        className="rounded-2xl p-5 border text-sm"
        style={{ borderColor: 'rgb(0 0 0 / 0.12)', background: 'color-mix(in oklab, var(--soft) 45%, transparent)' }}
      >
          ...
          >
            <div className="flex items-center gap-3">
              <div
                ...
                style={{ background: sw?.c ?? 'transparent', borderColor: 'rgb(0 0 0 / 0.10)' }}
              />
              <div>
                <div className="font-semibold">{r}</div>
                <div className="text-sm opacity-70">{sw ? `${sw.n} · ${sw.cat}` : '—'}</div>
              </div>
            </div>
...
function roleTip(r: 'Base' | 'Accent' | 'Metal') {
  if (r === 'Base') return 'Zemin/duvar gibi geniş yüzeyler: sakin ve zamansız tonlar.';
...
function computeRoles(picks: { n: string; c: string; cat: string }[]) {
  ...
  const metal = picks.find((p) => p.cat === 'Metal') || picks.find((p) => p.n.includes('Graphite'));
  const byLum = [...picks].sort((a, b) => luminance(hexToRgb(a.c)) - luminance(hexToRgb(b.c)));
  const base = byLum[byLum.length - 1]; // daha açık
  const accent = picks.find((p) => p.cat === 'Paint' || p.cat === 'Textile' || (p.cat === 'Wood' && p !== base)) || byLum[0];
...
function BeforeAfter({ before, after }: { before: string; after: string }) {
  ...
  return (
    ...
    >
      ...
      <input type="range" min={0} max={100} value={v} onChange={(e) => setV(Number(e.target.value))} className="w-full accent-current" />
    </div>
  );
}

/* --- Budget Card --- */
function BudgetCard({ className, area, program, quality }: { className?: string; area: number; program: Program; quality: Quality }) {
    ...
    >
      <div className="grid md:grid-cols-2 gap-4 items-start">
        <div>
          ...
          <div className="text-2xl font-extrabold">₺{unit.toLocaleString('tr-TR')}</div>
        ...
        <div>
          ...
          <div className="text-3xl font-extrabold">₺{subtotal.toLocaleString('tr-TR')}</div>
          <div className="text-xs opacity-70 mt-1">* Tamamen demo amaçlıdır; piyasaya göre değişir.</div>
        </div>
      </div>
      ...
      <div className="mt-5">
        ...
        <div className="grid md:grid-cols-3 gap-3 text-sm">
          {parts.map((p) => (
            <div key={p.label} className="rounded-xl p-3 border" style={{ borderColor: 'rgb(0 0 0 / 0.12)', background: 'var(--bg)' }}>
              <div className="font-medium">{p.label}</div>
              <div className="text-lg font-extrabold">₺{p.value.toLocaleString('tr-TR')}</div>
