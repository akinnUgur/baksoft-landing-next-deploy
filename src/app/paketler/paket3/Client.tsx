...
const REVIEWS = [
  { id: 'r1', name: 'Deniz', text: 'Loş ışık, iyi müzik ve efsane cinnamon latte. Tam “Friends” havası!' },
  { id: 'r2', name: 'Merve', text: 'Kış akşamı için ideal. Gingerbread latte bağımlılık yapıyor.' },
  { id: 'r3', name: 'Ege', text: 'Brownie glutensiz olmasına rağmen çok yoğun ve dengeli.' },
];

/* =========================
   Page
========================= */
export default function Paket3CozyCafeClient() {
  ...
  return (
    <main className="min-h-[100dvh] bg-[#15110f] text-amber-100 selection:bg-red-400/30">
      ...
      {/* Top strip (sabit renk) */}
      <div className="text-xs bg-stone-900 text-amber-100">
        <div className="mx-auto max-w-7xl px-4 py-2 flex items-center justify-between">
          <span className="tracking-wide opacity-90">Baksoft · Özelleştirilebilir Tasarım No:3 </span>
          <span className="opacity-90">Edition • <b>Concept</b></span>
        </div>
      </div>
      ...
      <header className="lg:ml-24 sticky top-0 z-40 border-b border-amber-900/40 bg-[#15110f]/70 backdrop-blur">
        <div className="mx-auto max-w-7xl px-5 h-16 flex items-center gap-4">
          {/* Logo + Marka */}
          <a href="/paketler" className="font-semibold tracking-wide flex items-center gap-2">
            <Image
              src="/baksoftLogo.png"
              alt="Baksoft Logo"
              width={32}
        ...
        <div className="mx-auto max-w-7xl px-5 py-12">
          <div className="grid md:grid-cols-12 gap-6 items-start">
            ...
            <div className="md:col-span-6">
              ...
              >
                <input required placeholder="İsim" className="col-span-2 h-11 rounded-xl bg-[#221b17] border border-amber-900/40 px-3" />
                <input required type="tel" placeholder="Telefon" className="col-span-2 md:col-span-1 h-11 rounded-xl bg-[#221b17] border border-amber-900/40 px-3" />
                <input required type="date" className="col-span-1 h-11 rounded-xl bg-[#221b17] border border-amber-900/40 px-3" />
                <input required type="time" className="col-span-1 h-11 rounded-xl bg-[#221b17] border border-amber-900/40 px-3" />
                ...
                <select className="col-span-1 h-11 rounded-xl bg-[#221b17] border-amber-900/40 border px-3">
                  {['Salon', 'Pencere Kenarı', 'Bar'].map((n) => <option key={n}>{n}</option>)}
                </select>
      ...
      <footer className="lg:ml-24 border-t border-amber-900/40">
        <div className="mx-auto max-w-7xl px-5 py-10 text-sm text-amber-300/80 flex flex-col md:flex-row gap-3 items-center justify-between">
          ...
          <div className="flex gap-4">
            <a className="hover:text-amber-100" href="#menu">Menü</a>
            <a className="hover:text-amber-100" href="#special">Bugünün Kahvesi</a>
            <a className="hover:text-amber-100" href="#">KVKK</a>
          </div>
        </div>
      </footer>
    </main>
