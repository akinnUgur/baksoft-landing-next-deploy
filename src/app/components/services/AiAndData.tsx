...
const items = [
  {
    ...
    title: "İşletmelere Özel AI",
    desc:
      "Talep tahmini, anomali tespiti, chatbot ve optimizasyon çözümleriyle süreçleri akıllandırın.",
  },
  {
    icon: <BrainCircuit className="w-5 h-5" />,
    title: "Ürün Odaklı AI",
    desc:
      "Kişiselleştirme, görsel/sesli işleme veya akıllı asistanlarla son kullanıcı deneyimini güçlendirin.",
  },
  {
    icon: <ServerCog className="w-5 h-5" />,
    title: "Model & Altyapı",
    desc:
      "Python, TensorFlow, PyTorch ve modern veri hatlarıyla üretim seviyesinde kurulum.",
  },
  {
    icon: <Filter className="w-5 h-5" />,
    title: "Veri Stratejisi",
    desc:
      "Toplama, temizleme, etiketleme ve modelleme aşamalarında uçtan uca danışmanlık.",
  },
];

export default function AiAndData() {
  return (
    <motion.section
      id="ai"
    ...
    >
      <div className="absolute top-0 left-0 w-[600px] h-[600px] rounded-full bg-gradient-to-br from-accent/10 to-favorite/20 blur-3xl opacity-30 dark:opacity-20 -z-10" />
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <p className="text-subtext dark:text-subtext-dark text-lg text-center max-w-3xl mx-auto mb-12">
          Verinizin potansiyelini ortaya çıkarın; veriye dayalı karar alma kültürünü yapay zekâ ile birleştirin.
        </p>
