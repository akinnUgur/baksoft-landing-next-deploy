...
export default function ServicesClient() {
  return (
    <main
      ...
      aria-label="Baksoft hizmetler sayfası"
    >
      {/* arka plan orbs */}
      ...
      <PageTransition>
        {/* HERO */}
        <section className="mx-auto max-w-7xl px-4 pt-14 md:pt-20 pb-8 md:pb-12" aria-labelledby="hero-heading">
          <h1 id="hero-heading" className="sr-only">Baksoft Hizmetler</h1>
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-4xl md:text-6xl font-semibold leading-[1.05] dark:text-text-dark">
              İhtiyaca uygun,{' '}
          ...
          {/* Sticky/quick nav */}
          <nav className="mt-8 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3" aria-label="Hizmet kısa menü">
        ...
        {/* CONTENT SECTIONS */}
        <section id="web" className="mx-auto max-w-7xl px-4 py-6 md:py-8" aria-labelledby="web-heading">
          <h3 id="web-heading" className="sr-only">Web Geliştirme</h3>
          <WebDevelopment />
        </section>

        <section id="mobil" className="mx-auto max-w-7xl px-4 py-6 md:py-8" aria-labelledby="mobil-heading">
          <h3 id="mobil-heading" className="sr-only">Mobil Uygulama Geliştirme</h3>
          <MobileDevelopment />
        </section>

        <section id="ozel" className="mx-auto max-w-7xl px-4 py-6 md:py-8" aria-labelledby="ozel-heading">
          <h3 id="ozel-heading" className="sr-only">Özel Yazılım Geliştirme</h3>
          <CustomSoftware />
        </section>

        <section id="ai" className="mx-auto max-w-7xl px-4 py-6 md:py-8" aria-labelledby="ai-heading">
          <h3 id="ai-heading" className="sr-only">Yapay Zekâ ve Veri Bilimi</h3>
          <AiAndData />
        </section>

        <section id="destek" className="mx-auto max-w-7xl px-4 py-6 md:py-8" aria-labelledby="destek-heading">
          <h3 id="destek-heading" className="sr-only">Danışmanlık ve Teknik Destek</h3>
          <Consulting />
        </section>
      </PageTransition>
